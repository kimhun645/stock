      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h3 className="text-lg font-semibold text-white">แจ้งเตือนสต็อกต่ำ</h3>
          </div>
          <div className="space-y-3">
              ...
              lowStockMaterials.map((material) => (
                <div key={material.id} className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                  <div>
                    ...
                    <p className="text-white/60 text-sm">หมวดหมู่: {material.category}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-yellow-400 font-medium">{material.stockQuantity} {material.unit}</p>
                    <p className="text-white/60 text-sm">ขั้นต่ำ: {material.minStockLevel}</p>
                  </div>
                </div>
              ))
            ) : (
